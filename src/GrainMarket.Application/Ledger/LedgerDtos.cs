...
public record LedgerRowDto(int Id, DateTime Date, decimal Debit, decimal Credit, decimal RunningBalance, LedgerSourceType SourceType, int SourceId, string? Description, string? ReferenceNo);
